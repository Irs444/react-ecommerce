...
const address = [
    {
        name: "Irshad",
        street: "sec-10 Indira nagar lko",
        city: "Lucknow",
        pinCode: 226016,
        state: "Uttar Pardesh",
        phone: 7497940723
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className='grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5'>
                ...
                <div className='lg:col-span-2'>
                    <div className="mx-auto mt-5 bg-white shadow-xl border rounded-lg max-w-7xl px-4 sm:px-6 lg:px-8">
                        <h1 className='text-2xl py-2 font-bold tracking-light text-gray-900'>Cart</h1>
